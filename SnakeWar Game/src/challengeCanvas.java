...
class challengeCanvas extends GameCanvas implements Runnable
{
...
public int timepass=100;

public int gamePause=100;

public boolean playing;
public boolean paused=false;
public boolean tim_brk=false;

public boolean p1enter=false,p2enter=false,p3enter=false,p4enter=false;

public boolean p2bypass=false,p2bypass1=false,p2bypass2=false;
public boolean p3bypass=false,p3bypass1=false,p3bypass2=false;
public boolean p4bypass=false,p4bypass1=false,p4bypass2=false;
...
public Image p1_head,p2_head,p3_head,p4_head,sudo_head,sudo_head2;
public Sprite p11,p21,p31,p41,p21s,p31s,p41s,p21ss,p21sl,p21sr,p31ss,p31sl,p31sr,p41ss,p41sl,p41sr;
...
// food image variable
public Image food_ball,speedUp_ball,speedDown_ball,megaPower_ball,poison_ball,time_breaker;
public Sprite food,speedUp,speedDown,megaPower,poison,tbreak;
...
public challengeCanvas(int whichArena,int whichColor,int speed,int ent,int timed,SnakeWar parent) throws IOException 
{
super(true);
this.parent=parent;
Graphics g = getGraphics();
mLayerManager = new LayerManager();
mFont = Font.getFont(Font.FACE_MONOSPACE,Font.STYLE_PLAIN , Font.SIZE_MEDIUM);
nump=3;
enter=ent;
type=1;
p1Scr=parent.SCORE;
...
if(enter==1)
{
	...
	if(timepass==0)
	{
		...
		else if(p3enter==false)
		{
			p3enter=true;
			timepass=100;
		}
		else if(p4enter==false)
		{
			p4enter=true;
			timepass=100;
		}
...
time_breaker = Image.createImage("/timebreaker.png");
}catch(Exception ds){}
g.setFont(mFont);
}
...
public void placeScore()
{
	...
	g.fillRect(0,0,240,16);
		...
		g.fillRect(240,0,140,360);
		g.fillRect(0,314,280,140);
...
else if(nump==3)
{
	...
	g.drawString(String.valueOf(p4Scr),130+15,-3,0);
		...
		if(tim_brk==true)
		{
			g.drawImage(time_breaker,230,0,0);
		}
		else
		{
		}
...
public void getFood()
{
		try
		{
			...
			time_breaker=Image.createImage("/timebreaker.png");
			tbreak = new Sprite(time_breaker);
...
if(food.collidesWith(Arena,true)==true)
  ...
  placeFood();
        ...
        placeSur();
if(speedUp.collidesWith(Arena,true)==true || speedDown.collidesWith(Arena,true)==true || poison.collidesWith(Arena,true)==true || megaPower.collidesWith(Arena,true)==true || tbreak.collidesWith(Arena,true)==true)
        {
  placeSur();
        }
else
...
if(speedUp.collidesWith(food,true)==true || speedDown.collidesWith(food,true)==true || poison.collidesWith(food,true)==true || megaPower.collidesWith(food,true)==true || tbreak.collidesWith(food,true)==true)
        {
  placeSur();
        }
else
	...
	Graphics g=getGraphics();
       ...
       surX=getFoodX();
        ...
        else //if(rand==17)
        {
        	if(tbreaker>0)
        	{
        		tbreak.setPosition(surX,surY);
        		mLayerManager.insert(tbreak,0);
        			mLayerManager.paint(g, 0, 0);
        			surIsDisp=true;
        			tbreaker--;
        	}
...
public int getFoodY()
{
	...
	int fY = generatorY.nextInt(309-11)+16;
			return(fY);
}
...
p21ss.setPosition(p2X+3,p2Y-3);
p21sl.setPosition(p2X-3,p2Y+10);
p21sr.setPosition(p2X+9,p2Y+10);
...
p21ss.setPosition(p2X+3,p2Y+11);
p21sl.setPosition(p2X+9,p2Y);
p21sr.setPosition(p2X-3,p2Y);
}
...
p21ss.setPosition(p2X+11,p2Y+3);
p21sl.setPosition(p2X,p2Y-3);
p21sr.setPosition(p2X,p2Y+9);
}
...
p21ss.setPosition(p2X-3,p2Y+3);
p21sl.setPosition(p2X+10,p2Y+9);
p21sr.setPosition(p2X+10,p2Y-3);
}
...
p31.setPosition(p3X,p3Y);
p31s.setPosition(p3X,p3Y);
p31ss.setPosition(p3X+3,p3Y-3);
p31sl.setPosition(p3X-3,p3Y+10);
p31sr.setPosition(p3X+9,p3Y+10);
}
...
p31.setPosition(p3X,p3Y);
p31s.setPosition(p3X,p3Y);
p31ss.setPosition(p3X+3,p3Y+11);
p31sl.setPosition(p3X+9,p3Y);
p31sr.setPosition(p3X-3,p3Y);
}
...
p31.setPosition(p3X,p3Y);
p31s.setPosition(p3X,p3Y);
p31ss.setPosition(p3X+11,p3Y+3);
p31sl.setPosition(p3X,p3Y-3);
p31sr.setPosition(p3X,p3Y+9);
...
p31s.setPosition(p3X,p3Y);
p31ss.setPosition(p3X-3,p3Y+3);
p31sl.setPosition(p3X+10,p3Y+9);
p31sr.setPosition(p3X+10,p3Y-3);
...
p41.setPosition(p4X,p4Y);
p41s.setPosition(p4X,p4Y);
p41ss.setPosition(p4X+3,p4Y-3);
p41sl.setPosition(p4X-3,p4Y+10);
p41sr.setPosition(p4X+9,p4Y+10);
...
p41.setPosition(p4X,p4Y);
p41s.setPosition(p4X,p4Y);
p41ss.setPosition(p4X+3,p4Y+11);
p41sl.setPosition(p4X+9,p4Y);
p41sr.setPosition(p4X-3,p4Y);
...
p41.setPosition(p4X,p4Y);
p41s.setPosition(p4X,p4Y);
p41ss.setPosition(p4X+11,p4Y+3);
p41sl.setPosition(p4X,p4Y-3);
p41sr.setPosition(p4X,p4Y+9);
...
p41s.setPosition(p4X,p4Y);
p41ss.setPosition(p4X-3,p4Y+3);
p41sl.setPosition(p4X+10,p4Y+9);
p41sr.setPosition(p4X+10,p4Y-3);
...
public void getPlayer2()
{
	...
	try{
		...
		p21s=new Sprite(sudo_head);
				sudo_head2=Image.createImage("/sudo_head2.png");
				p21ss=new Sprite(sudo_head2);
				p21sl=new Sprite(sudo_head2);
				p21sr=new Sprite(sudo_head2);
...
public void getPlayer3()
{
	...
	try{
		...
		sudo_head2=Image.createImage("/sudo_head2.png");
				p31ss=new Sprite(sudo_head2);
				p31sl=new Sprite(sudo_head2);
				p31sr=new Sprite(sudo_head2);
...
public void getPlayer4()
{
	...
	try{
		...
		sudo_head2=Image.createImage("/sudo_head2.png");
				p41ss=new Sprite(sudo_head2);
				p41sl=new Sprite(sudo_head2);
				p41sr=new Sprite(sudo_head2);
...
if(dir==1) // UP DIRECTION
{
	p21.setTransform(Sprite.TRANS_MIRROR_ROT90);
		p21s.setTransform(Sprite.TRANS_MIRROR_ROT90);
				p21ss.setTransform(Sprite.TRANS_MIRROR_ROT90);
	p22.setTransform(Sprite.TRANS_MIRROR_ROT90);
	p23.setTransform(Sprite.TRANS_MIRROR_ROT90);
p21.setPosition(x,y);
p21s.setPosition(x,y);

p21ss.setPosition(x+3,y-3);
p21sl.setPosition(x-3,y+3);
p21sr.setPosition(x+9,y+3);
...
else if(dir==2) // DOWN DIRECTION
{
	...
	p21s.setTransform(Sprite.TRANS_ROT90);
		p21ss.setTransform(Sprite.TRANS_ROT90);
	p22.setTransform(Sprite.TRANS_ROT90);
	p23.setTransform(Sprite.TRANS_ROT90);
p21.setPosition(x,y);
p21s.setPosition(x,y);

p21ss.setPosition(x+3,y+11);
p21sr.setPosition(x-3,y+8);
p21sl.setPosition(x+9,y+8);
...
p21ss.setPosition(x+11,y+3);
p21sl.setPosition(x+8,y-3);
p21sr.setPosition(x+8,y+9);
...
else if(dir==4) // LEFT DIRECTION
{
	...
	p21s.setTransform(Sprite.TRANS_MIRROR);
		p21ss.setTransform(Sprite.TRANS_MIRROR);
	p22.setTransform(Sprite.TRANS_MIRROR);
	p23.setTransform(Sprite.TRANS_MIRROR);
p21.setPosition(x,y);
p21s.setPosition(x,y);

p21ss.setPosition(x-5,y+3);
p21sl.setPosition(x+3,y+9);
p21sr.setPosition(x+3,y-3);
...
mLayerManager.insert(p21ss,0);
mLayerManager.insert(p21sl,0);
mLayerManager.insert(p21sr,0);
...
p31ss.setPosition(x+3,y-3);
p31sl.setPosition(x-3,y+3);
p31sr.setPosition(x+9,y+3);
...
p31ss.setPosition(x+3,y+11);
p31sr.setPosition(x-3,y+8);
p31sl.setPosition(x+9,y+8);
...
p31ss.setPosition(x+11,y+3);
p31sl.setPosition(x+8,y-3);
p31sr.setPosition(x+8,y+9);
...
p31ss.setPosition(x-5,y+3);
p31sl.setPosition(x+3,y+9);
p31sr.setPosition(x+3,y-3);
...
mLayerManager.insert(p31ss,0);
mLayerManager.insert(p31sl,0);
mLayerManager.insert(p31sr,0);
...
p41ss.setPosition(x+3,y-3);
p41sl.setPosition(x-3,y+3);
p41sr.setPosition(x+9,y+3);
...
p41ss.setPosition(x+3,y+11);
p41sr.setPosition(x-3,y+8);
p41sl.setPosition(x+9,y+8);
...
p41ss.setPosition(x+11,y+3);
p41sl.setPosition(x+8,y-3);
p41sr.setPosition(x+8,y+9);
...
p41ss.setPosition(x-5,y+3);
p41sl.setPosition(x+3,y+9);
p41sr.setPosition(x+3,y-3);
...
mLayerManager.insert(p41ss,0);
mLayerManager.insert(p41sl,0);
mLayerManager.insert(p41sr,0);
...
public void collisionDetectorP1()
{
	...
	{//@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
        	...
        	else if(p11.collidesWith(tbreak,true)==true)
        	{
        	tim_brk=true;
        	surX=500;
        	surY=500;
...
if(p2Scr>=0)
{
	...
	{//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
		...
		if(p21.collidesWith(food,true)==true)
        {
        	...
        	else if(p21.collidesWith(tbreak,true)==true)
        	{
        	surX=500;
        	surY=500;
			moveSur();      
...
if(p3Scr>=0)
{
	...
	{//########################################################
    	...
    	else if(p31.collidesWith(tbreak,true)==true)
        	{
        	surX=500;
        	surY=500;
			moveSur();      
...
{ 
	...
	{//$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
    	...
    	else if(p41.collidesWith(tbreak,true)==true)
        	{
        	surX=500;
        	surY=500;
			moveSur();      
...
if(p2enter==true)
		...
		if((p21ss.collidesWith(Arena,false)==true) && (p21sl.collidesWith(Arena,false)==true) && (p21sr.collidesWith(Arena,false)==true))
		{
			p2initial();
			p2Scr--;
			if(p2bypass2==false)
	...
	else if(snk==3)
	{
		...
		if((p31ss.collidesWith(Arena,false)==true) && (p31sl.collidesWith(Arena,false)==true) && (p31sr.collidesWith(Arena,false)==true))
		{
			p3initial();
			p3Scr--;
			if(p3bypass2==false)
	...
	else if(snk==4)
	{
		...
		if((p41ss.collidesWith(Arena,false)==true) && (p41sl.collidesWith(Arena,false)==true) && (p41sr.collidesWith(Arena,false)==true))
		{
			p4initial();
			p4Scr--;
			if(p4bypass2==false)
